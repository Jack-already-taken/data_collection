...
# this version runs the model from files saved locally aiming to reduce the
# time needed to load the model, but has questionable effect
# change the absolute directory according to local directory structure
tokenizer = GPT2Tokenizer.from_pretrained("/home/syed/Documents/test_traces/models/persona")
model = GPT2LMHeadModel.from_pretrained("/home/syed/Documents/test_traces/models/persona")
